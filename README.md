...
moreutils | isutf8, [parallel](#parallel), sponge | :heavy_check_mark: | | <a id="moreutils"></a> |
...
rclone | sync files to/from GDrive/OneDrive | :heavy_multiplication_x: | [RClone](http://rclone.org/) | <a id="rclone"></a> |
